...
const TimeLine = () => {
  ...
  >
    ...
    <Text fz={"1.5rem"}>5:00 PM - Check In</Text>
  ...
  >
    ...
    <Text fz={"1.5rem"}>5:30 PM - Opening Ceremony and Inauguration</Text>
  ...
  >
    ...
    <Text fz={"1.5rem"}>6:30 PM - Hack Starts</Text>
  </VerticalTimelineElement><VerticalTimelineElement
    className="vertical-timeline-element--work test"
    contentStyle={{ background: 'rgba(255,255,255,0.05)', color: '#fff', boxShadow : "0 3px 0 #f5bffb" }}
    contentArrowStyle={{ borderRight: '7px solid  rgba(255,255,255,0.05)' }}
  ...
  >
    ...
    <Text fz={"1.5rem"}>8:00PM - Dinner</Text>
  </VerticalTimelineElement>
...
<div className='daytimeline'><Title fz={"2rem"} c={"#f5bffb"}>28th October</Title></div>
  ...
  >
    ...
    <Text fz={"1.5rem"}>8:00 AM - BreakFast</Text>
  ...
  >
    ...
    <Text fz={"1.5rem"}>11:00 AM - Speaker Session 1</Text>
  </VerticalTimelineElement><VerticalTimelineElement
    className="vertical-timeline-element--work test"
    contentStyle={{ background: 'rgba(255,255,255,0.05)', color: '#fff', boxShadow : "0 3px 0 #f5bffb" }}
    contentArrowStyle={{ borderRight: '7px solid  rgba(255,255,255,0.05)' }}
  ...
  >
    ...
    <Text fz={"1.5rem"}>12:30 PM - Lunch</Text>
  ...
  >
    <IconMicrophone2 style={{color : "#f5bffb"}} size={"5rem"} strokeWidth={"1px"}/>
    <Text fz={"1.5rem"}>2:00 PM - Speaker Session 2</Text>
  </VerticalTimelineElement>
  <VerticalTimelineElement
    className="vertical-timeline-element--work test"
    contentStyle={{ background: 'rgba(255,255,255,0.05)', color: '#fff', boxShadow : "0 3px 0 #f5bffb" }}
  ...
  >
    ...
    <Text fz={"1.5rem"}>5:30PM - Review</Text>
  </VerticalTimelineElement><VerticalTimelineElement
    className="vertical-timeline-element--work test"
    contentStyle={{ background: 'rgba(255,255,255,0.05)', color: '#fff', boxShadow : "0 3px 0 #f5bffb" }}
    contentArrowStyle={{ borderRight: '7px solid  rgba(255,255,255,0.05)' }}
...
<div className='daytimeline'><Title fz={"2rem"} c={"#f5bffb"}>29th October</Title></div>
  ...
  >
    ...
    <Text fz={"1.5rem"}>1:00 PM - Judging Starts</Text>
  </VerticalTimelineElement>
  ...
  >
    ...
    <Text fz={"1.5rem"}>7:00 PM - Closing Ceremony</Text>
  </VerticalTimelineElement>
</VerticalTimeline>
